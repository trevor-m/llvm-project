...
// CHECK-LABEL: @tensor.bitcast_chain_ok
// CHECK-SAME: %[[IN:.*]]: tensor<2xi32>
func.func @tensor.bitcast_chain_ok(%input: tensor<2xi32>) -> tensor<2xf32> {
...
// CHECK-LABEL: @tensor.bitcast_chain_nop
// CHECK-SAME: %[[IN:.*]]: tensor<4xi32>
func.func @tensor.bitcast_chain_nop(%input: tensor<4xi32>) -> tensor<4xi32> {
